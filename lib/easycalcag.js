...
var App = 'Easycalc',
    ...
    category = 0,
    currCat = category,
    timerInternet, timer1 = null, timer2 = null, timer3 = null, delayTimer3 = 500, timer4 = null, timer5 = null,
    timer6 = null, timer7 = null, timer8 = null, timer9 = null, timer10 = null, timer11 = null, timer12 = null,
    timer13 = null, timer14 = null, timer15 = null, timer16 = null, timer17 = null, timer18 = null, timer19 = null,
    timer20 = null, timerChronos = 0, timerConsole = null,
    sliderVisible = 0,
    sliderSpeed = 600,
    priceSaveAlert = -9999,
    ...
    hello, optionBoxesHeight, Optiontax, Optionglobaldiscount, Optionudderdiscount, Optionpricecheckplus, Optionsound,
    Optionproductrange, Optionuser, Optionmonths, Optioncountry, Optioncurrency, Optiondate, Optionlocaldocs,
    OptioncostGMilk, OptioncostDCM, OptioncostGDCM, Optionpriceperkg, Optionagreement, Optionautoprice,
    Optionhelpacidalk, Optionbreedingwidget, OptionAOC, Optionfilecontactdate, Optionfiledate, Optionskipintro,
    Optiontooltips, OptionlowresPDF, Optiondistriblogo, Optioncontact, Optionnodemotooltips, Optiondemoloop,
    Optionproductmosaic, Optionoldprodmosaic, OptionFSoptions, Optionshippingbottom, Optioncalendar, Optioncopycci,
    Optionpwdprices, Optionmailfilerec, Optiondemobig, Optionspeeddemo, Optionstatictabs,
    ...
    myData, loadProcess = false, loadPricesProcess = false, loadEnded = null, deleteProcess, newfileData = [],
    fileData = [], previousfileData = [], backupData, infoData = [], oldInfoData = [],
...
function saveProductImgDB() {
    ...
    if (!$('body').data('cors-Img-OK')) {
        alert('Souci CORS, changez de navigateur…');
        return;
    }
...
function closeMosaic() {
    ...
    if ($('#mosaiclist-save').isVisible() && $('.mosaic-chosen').length && !$('#mosaiclist-save').hasClass('saved')) {
        if (!confirm(dialogText[4].split(CO)[lang])) {
            return;
        }
    }
...
function tankCalc(box) {
    ...
    subconsforcalc2 = box.find('.subconsforcalc2').val();
    if (Number(subconsforcalc2) === 0 || changedEauDouce) {
        box.find('.subconsforcalc2').val(Math.ceil(cleanings));
    }
    subconsforcalc2 = box.find('.subconsforcalc2').val();
    prodcalc = parseInt(subconsforcalc * 0.01 * watercons * density * subconsforcalc2);
    prodcalcText = '% x &W x &D x'
...
function createStructure() {
    ...
    for (var l = 0; l < animalScope; l++) {
        htmlX += '<div class="animal"><div class="flip"><div class="animal-back-image-container"><div class="animal-back-image"><img class="animal-image" src="' + imgFolder + SL + 'menu-' + animals[l] + jpg + '" ><img class="animal-go" src="' + imgFolder + SL + 'go-menu.svg"/><div class="animalgoSpinner"/></div></div></div></div>';
    }
